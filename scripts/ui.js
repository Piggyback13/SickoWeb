...
lines = ['Привет! Меня зовут Sicko! Хочешь сыграть со мной в игру? В процессе игры мы изучим веб-технологии, включая один из самых популярных языков программирования - JavaScript, используемый для создания веб страниц и сайтов.',
			'Hello! My name is Sicko! Do you want to play a game with me? During the game, we will learn web technologies, including one of the most popular programming languages - JavaScript, used to create web pages and sites.'];
